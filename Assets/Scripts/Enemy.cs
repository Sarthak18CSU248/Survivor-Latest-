...
public class Enemy : MonoBehaviour
{
    ...
    public GameObject Player,EnemyCanvas,arrowpopup,Tag;
    ...
    void Start()
    {
        ...
        arrow = Player.GetComponent<ArrowTest>();
    }
    ...
    private IEnumerator ArrowPopup()
    {
